...
import type { PostApiAuthLoginData, PostApiAuthLoginResponses, GetApiUsersCurrentData, GetApiUsersCurrentResponses } from './types.gen';
...
export const getApiUsersCurrent = <ThrowOnError extends boolean = false>(options?: Options<GetApiUsersCurrentData, ThrowOnError>) => {
